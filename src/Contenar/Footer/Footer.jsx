...
<div className='d-flex  justify-content-center ' style={{'gap':'15px','alignItems':'center' ,'marginTop':'30px','color':'white'}} >
    <div style={{'display':'flex','alignItems':'center' ,'gap':'10px'}}>
        <img style={{'marginTop':'-9px'}} src="  /footer3.png" alt="" />
        <h1 style={{'fontSize':'16px','opacity':'60%'}}>Spotify</h1>
    </div>

    <div style={{'display':'flex','alignItems':'center' ,'gap':'10px'}}>
        <img style={{'marginTop':'-9px'}} src="  /cib_apple-podcasts.png" alt="" />
         <h1 style={{'fontSize':'16px','opacity':'60%'}}>Spotify</h1>
        
    </div>

    <div style={{'display':'flex','alignItems':'center' ,'gap':'10px'}}>
        <img style={{'marginTop':'-9px'}} src="  /footer5.png" alt="" />
        <h1 style={{'fontSize':'16px','opacity':'60%'}}>YouTube</h1>
    </div>

    <div style={{'display':'flex','alignItems':'center' ,'gap':'10px'}}>
        <img style={{'marginTop':'-9px'}} src="  /footer6.png" alt="" />
